...
<p align="center"><strong><a href="https://github.com/open-templates">@open-templates</a></strong> के starter repos — अलग-अलग या जोड़े गए fullstack packs के रूप में उपयोग करें।</p>

<h3 align="center"><b>📄 Standalone</b></h3>

| Template | टेक स्टैक | विवरण |
| --- | --- | --- |
...
<p align="center"><em>Frontend और backend templates एक ही auth और API contracts से जुड़े — दोनों clone करें और ship करें।</em></p>

<h4 align="center"><b>🔐 Supabase Auth Pack</b></h4>

| Role | Template | टेक स्टैक | विवरण |
| --- | --- | --- | --- |
