...
<p>Marketplace peer-to-peer لتأجير السيارات مستوحى من <strong>Airbnb</strong> — استأجر من مالكين محليين بدلًا من مكاتب التأجير التقليدية. frontendان proof-of-concept بـ <strong>Lovable</strong> و<strong>Vercel v0</strong> لمقارنة AI-assisted UI generation workflows.</p>
<p>
...
<h3 align="center"><b>⚡ حزم Fullstack</b></h3>

<p align="center"><em>قوالب frontend وbackend متصلة بنفس عقود auth وAPI — انسخ الاثنين وانشر.</em></p>

<h4 align="center"><b>🔐 حزمة Supabase Auth</b></h4>

| الدور | القالب | مجموعة التقنيات | الوصف |
| --- | --- | --- | --- |
