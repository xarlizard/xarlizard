...
<p>Marketplace peer-to-peer de lloguer de cotxes inspirat en <strong>Airbnb</strong> — lloga a particulars en lloc de mostradors tradicionals. Dos frontends de prova amb <strong>Lovable</strong> i <strong>Vercel v0</strong> per comparar fluxos de generació d'UI assistida per IA.</p>
<p>
